...
class menu:
    ...
    def addMenuItem(self, title, callback):
        """
...
"""
    ...
    def addCheckmarkMenuItem(self, title, initialValue, callback):
        """
...
"""
    ...
    def addOptionsMenuItem(self, title, options, initalValue, callback):
        """
...
"""
        self._class = playdate.geometry.affineTransform.new(*args, **kwargs)
...
"""
    ...
    def rotatedBy(self, angle, point):
        """
Returns a copy of the calling affine transform with a rotate transformation appended.
...
"""
    ...
    def transformLineSegment(self, ls):
        """
...
"""
    ...
    def transformedLineSegment(self, ls):
        """
...
class arc:
    def __init__(self, x, y, radius, startAngle, endAngle, direction):
        """
...
"""
    ...
    def pointOnArc(self, distance, extend):
        """
...
"""
    ...
    def pointOnLine(self, distance, extend):
        """
...
"""
    ...
    def closestPointOnLineToPoint(self, p):
        """
...
"""
    ...
    def intersectsLineSegment(self, ls):
        """
...
"""
    ...
    def intersectsPolygon(self, poly):
        """
...
"""
        self._class = playdate.geometry.point.new(*args, **kwargs)
...
class polygon:
    def __init__(self, *args, **kwargs):
        """
"""
        self._class = playdate.geometry.polygon.new(*args, **kwargs)
...
"""
    ...
    def containsPoint(self, p, fillRule):
        """
"""
        playdate.geometry.polygon.containsPoint(self._class, p, fillRule)

    def containsPoint(self, x, y, fillRule):
        """
...
"""
    ...
    def pointOnPolygon(self, distance, extend):
        """
...
"""
        self._class = playdate.geometry.rect.new(*args, **kwargs)
...
"""
    ...
    def containsRect(self, x, y, width, height):
        """
...
"""
    ...
    def flipRelativeToRect(self, r2, flip):
        """
...
"""
        self._class = playdate.geometry.size.new(*args, **kwargs)
...
"""
        self._class = playdate.geometry.vector2D.new(*args, **kwargs)
...
"""
        self._class = playdate.graphics.image.new(*args, **kwargs)
...
"""
    ...
    def draw(self, x, y, flip, sourceRect):
        """
"""
        playdate.graphics.image.draw(self._class, x, y, flip, sourceRect)

    def draw(self, p, flip, sourceRect):
        """
...
"""
    ...
    def drawAnchored(self, x, y, ax, ay, flip):
        """
...
"""
    ...
    def drawCentered(self, x, y, flip):
        """
...
"""
    ...
    def drawIgnoringOffset(self, x, y, flip):
        """
"""
        playdate.graphics.image.drawIgnoringOffset(self._class, x, y, flip)

    def drawIgnoringOffset(self, p, flip):
        """
...
"""
    ...
    def drawRotated(self, x, y, angle, scale, yscale):
        """
...
"""
    ...
    def rotatedImage(self, angle, scale, yscale):
        """
...
"""
    ...
    def drawScaled(self, x, y, scale, yscale):
        """
...
"""
    ...
    def scaledImage(self, scale, yscale):
        """
...
"""
    ...
    def drawWithTransform(self, xform, x, y):
        """
...
"""
    ...
    def transformedImage(self, xform):
        """
...
"""
    ...
    def drawSampled(self, x, y, width, height, centerx, centery, dxx, dyx, dxy, dyy, dx, dy, z, tiltAngle, tile):
        """
...
"""
    ...
    def drawTiled(self, x, y, width, height, flip):
        """
"""
        playdate.graphics.image.drawTiled(self._class, x, y, width, height, flip)

    def drawTiled(self, rect, flip):
        """
...
"""
    ...
    def drawBlurred(self, x, y, radius, numPasses, ditherType, flip, xPhase, yPhase):
        """
...
"""
    ...
    def blurredImage(self, radius, numPasses, ditherType, padEdges, xPhase, yPhase):
        """
...
"""
    ...
    def drawFaded(self, x, y, alpha, ditherType):
        """
...
"""
    ...
    def fadedImage(self, alpha, ditherType):
        """
...
"""
    ...
    def blendWithImage(self, image, alpha, ditherType):
        """
...
class nineSlice:
    def __init__(self, imagePath, innerX, innerY, innerWidth, innerHeight):
        """
...
class loop:
    def __init__(self, delay, imageTable, shouldLoop):
        """
...
"""
    ...
    def setImageTable(self, imageTable):
        """
...
"""
        self._class = playdate.graphics.animator.new(*args, **kwargs)
...
class blinker:
    def __init__(self, onDuration, offDuration, loop, cycles, default):
        """
...
"""
    ...
    def start(self, onDuration, offDuration, loop, cycles, default):
        """
...
"""
        self._class = playdate.graphics.imagetable.new(*args, **kwargs)
...
"""
    ...
    def drawIgnoringOffset(self, x, y, sourceRect):
        """
...
"""
    ...
    def setTileAtPosition(self, x, y, index):
        """
...
"""
    ...
    def getCollisionRects(self, emptyIDs):
        """
...
"""
        self._class = playdate.graphics.sprite.new(*args, **kwargs)

    def setImage(self, image, flip, scale, yscale):
        """
...
"""
    ...
    def setScale(self, scale, yScale):
        """
...
"""
    ...
    def setRotation(self, angle, scale, yScale):
        """
...
"""
    ...
    def setImageDrawMode(self, mode):
        """
...
"""
    ...
    def setImageFlip(self, flip, flipCollideRect):
        """
...
"""
    ...
    def setIgnoresDrawOffset(self, flag):
        """
...
"""
    ...
    def setBounds(self, upper_left_x, upper_left_y, width, height):
        """
...
"""
    ...
    def setAnimator(self, animator, moveWithCollisions, removeOnCollision):
...
"""
    ...
    def setClipRect(self, x, y, width, height):
        """
"""
...
"""
    ...
    def setStencilImage(self, stencil, tile):
        """
...
"""
    ...
    def setStencilPattern(self, level, ditherType):
        """
...
"""
    ...
    def setRedrawsOnImageChange(self, flag):
        """
...
"""
    ...
    def setCollideRect(self, x, y, width, height):
        """
"""
        playdate.graphics.sprite.setCollideRect(self._class, x, y, width, height)

    def setCollideRect(self, rect):
        """
...
"""
    ...
    def alphaCollision(self, anotherSprite):
        """
...
"""
    ...
    def setCollisionsEnabled(self, flag):
        """
...
"""
    ...
    def setCollidesWithGroups(self, groups):
        """
...
"""
    ...
    def setCollidesWithGroupsMask(self, mask):
        """
...
"""
    ...
    def getCollidesWithGroupsMask(self, ):
        """
...
"""
    ...
    def resetCollidesWithGroupsMask(self, ):
        """
...
"""
    ...
    def moveWithCollisions(self, goalX, goalY):
        """
"""
        playdate.graphics.sprite.moveWithCollisions(self._class, goalX, goalY)

    def moveWithCollisions(self, goalPoint):
        """
...
"""
    ...
    def drawText(self, text, x, y, width, height, leadingAdjustment, wrapMode, alignment):
        """
"""
        playdate.graphics.font.drawText(self._class, text, x, y, width, height, leadingAdjustment, wrapMode, alignment)

    def drawText(self, text, rect, leadingAdjustment, wrapMode, alignment):
        """
...
"""
    ...
    def drawTextAligned(self, text, x, y, alignment, leadingAdjustment):
...
"""
        self._class = playdate.pathfinder.graph.new(*args, **kwargs)

    def addNewNode(self, id, x, y, connectedNodes, weights, addReciprocalConnections):
        """
...
"""
    ...
    def addNode(self, node, connectedNodes, weights, addReciprocalConnections):
        """
...
"""
    ...
    def addConnectionToNodeWithID(self, fromNodeID, toNodeID, weight, addReciprocalConnection):
        """
...
"""
    ...
    def removeAllConnectionsFromNodeWithID(self, id, removeIncoming):
        """
...
"""
    ...
    def findPath(self, startNode, goalNode, heuristicFunction, findPathToGoalAdjacentNodes):
        """
...
"""
    ...
    def findPathWithIDs(self, startNodeID, goalNodeID, heuristicFunction, findPathToGoalAdjacentNodes):
        """
...
"""
    ...
    def setXYForNodeWithID(self, id, x, y):
        """
...
"""
    ...
    def addConnection(self, node, weight, addReciprocalConnection):
        """
...
"""
    ...
    def addConnections(self, nodes, weights, addReciprocalConnections):
        """
...
"""
    ...
    def addConnectionToNodeWithXY(self, x, y, weight, addReciprocalConnection):
        """
...
"""
    ...
    def removeConnection(self, node, removeReciprocal):
        """
...
"""
    ...
    def removeAllConnections(self, removeIncoming):
        """
...
"""
        self._class = playdate.sound.sampleplayer.new(*args, **kwargs)
...
"""
    ...
    def play(self, repeatCount, rate):
        """
...
"""
    ...
    def playAt(self, when, vol, rightvol, rate):
        """
...
"""
    ...
    def setLoopCallback(self, callback, arg):
        """
...
"""
    ...
    def setPlayRange(self, start, _end):
        """
...
"""
    ...
    def setFinishCallback(self, func, arg):
        """
...
"""
        self._class = playdate.sound.fileplayer.new(*args, **kwargs)
...
"""
    ...
    def setStopOnUnderrun(self, flag):
        """
...
"""
    ...
    def setLoopRange(self, start, _end, loopCallback, arg):
        """
...
"""
    ...
    def setBufferSize(self, seconds):
        """
...
"""
    ...
    def setVolume(self, left, right, fadeSeconds, fadeCallback, arg):
        """
...
"""
        self._class = playdate.sound.sample.new(*args, **kwargs)
...
"""
    ...
    def getSubsample(self, startOffset, endOffset):
        """
...
"""
        self._class = playdate.sound.channel.new(*args, **kwargs)
...
"""
        self._class = playdate.sound.synth.new(*args, **kwargs)
...
"""
    ...
    def playNote(self, pitch, volume, length, when):
        """
...
"""
    ...
    def playMIDINote(self, note, volume, length, when):
        """
...
"""
    ...
    def setAmplitudeMod(self, signal):
        """
...
"""
    ...
    def setADSR(self, attack, decay, sustain, release):
        """
...
"""
    ...
    def setEnvelopeCurvature(self, amount):
        """
...
"""
    ...
    def setFinishCallback(self, _function):
        """
...
"""
    ...
    def setFrequencyMod(self, signal):
        """
...
"""
    ...
    def setWavetable(self, sample, samplesize, xsize, ysize):
        """
...
"""
    ...
    def setParameterMod(self, parameter, signal):
        """
...
"""
        self._class = playdate.sound.lfo.new(*args, **kwargs)
...
"""
    ...
    def setArpeggio(self, note1, *args):
        """
...
"""
        playdate.sound.lfo.setArpeggio(self._class, note1, *args)
...
"""
    ...
    def setDelay(self, holdoff, ramp):
        """
...
"""
        self._class = playdate.sound.envelope.new(*args, **kwargs)
...
"""
    ...
    def setVelocitySensitivity(self, amount):
        """
...
"""
    ...
    def setRateScaling(self, scaling, start, _end):
        """
...
"""
    ...
    def trigger(self, velocity, length):
        """
...
"""
    ...
    def setUndersamplingMod(self, signal):
        """
Sets a signal to modulate the filter level. Set to nil to clear the modulator.
Ring Modulator
...
"""
    ...
    def setResonanceMod(self, signal):
        """
...
"""
        self._class = playdate.sound.sequence.new(*args, **kwargs)

    def play(self, finishCallback):
        """
...
"""
    ...
    def setTempo(self, stepsPerSecond):
        """
...
"""
    ...
    def setLoops(self, startStep, endStep, loopCount):
        """
...
"""
    ...
    def setTrackAtIndex(self, n, track):
        """
...
"""
        self._class = playdate.sound.track.new(*args, **kwargs)

    def addNote(self, step, note, length, velocity):
        """
"""
        playdate.sound.track.addNote(self._class, step, note, length, velocity)

    def addNote(self, table):
        """
...
"""
    ...
    def getNotes(self, step, endstep):
        """
...
"""
        self._class = playdate.sound.instrument.new(*args, **kwargs)

    def addVoice(self, v, note, rangeend, transpose):
        """
...
"""
    ...
    def setPitchBendRange(self, halfsteps):
        """
...
"""
    ...
    def setTranspose(self, halfsteps):
        """
...
"""
    ...
    def playNote(self, frequency, vel, length, when):
        """
...
"""
    ...
    def playMIDINote(self, note, vel, length, when):
        """
...
"""
        self._class = playdate.sound.controlsignal.new(*args, **kwargs)

    def addEvent(self, step, value, interpolate):
        """
"""
...
"""
    ...
    def setControllerType(self, number):
        """
...
"""
        self._class = playdate.timer.new(duration, callback, *args)
...
"""
        self._class = playdate.timer.new(*args, **kwargs)
...
"""
        self._class = playdate.frameTimer.new(duration, callback, *args)
...
"""
        self._class = playdate.frameTimer.new(*args, **kwargs)
...
"""
    ...
    def drawCell(self, section, row, column, selected, x, y, width, height):
        """
...
"""
    ...
    def drawSectionHeader(self, section, x, y, width, height):
        """
...
"""
    ...
    def drawHorizontalDivider(self, x, y, width, height):
        """
...
"""
    ...
    def setNumberOfSections(self, num):
        """
...
"""
    ...
    def setNumberOfRowsInSection(self, section, num):
        """
...
"""
    ...
    def getNumberOfRowsInSection(self, section):
        """
...
"""
    ...
    def setNumberOfColumns(self, num):
        """
...
"""
        playdate.ui.gridview.setNumberOfRows(self._class, *args)

    def setCellSize(self, cellWidth, cellHeight):
        """
...
"""
    ...
    def setCellPadding(self, left, right, top, bottom):
        """
...
"""
    ...
    def setContentInset(self, left, right, top, bottom):
        """
...
"""
    ...
    def getCellBounds(self, section, row, column, gridWidth):
        """
...
"""
    ...
    def setSectionHeaderHeight(self, height):
        """
...
"""
    ...
    def setSectionHeaderPadding(self, left, right, top, bottom):
        """
...
"""
    ...
    def setHorizontalDividerHeight(self, height):
        """
...
"""
    ...
    def getHorizontalDividerHeight(self, ):
        """
...
"""
    ...
    def addHorizontalDividerAbove(self, section, row):
        """
...
"""
    ...
    def removeHorizontalDividers(self, ):
        """
...
"""
    ...
    def setScrollPosition(self, x, y, animated):
        """
...
"""
    ...
    def scrollToCell(self, section, row, column, animated):
        """
...
"""
    ...
    def scrollCellToCenter(self, section, row, column, animated):
        """
...
"""
    ...
    def scrollToRow(self, row, animated):
        """
...
"""
    ...
    def setSelection(self, section, row, column):
        """
...
"""
    ...
    def selectNextRow(self, wrapSelection, scrollToSelection, animate):
        """
...
"""
    ...
    def selectPreviousRow(self, wrapSelection, scrollToSelection, animate):
        """
...
"""
    ...
    def selectNextColumn(self, wrapSelection, scrollToSelection, animate):
        """
...
"""
    ...
    def selectPreviousColumn(self, wrapSelection, scrollToSelection, animate):
        """
