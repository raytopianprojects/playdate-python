...
affineTransform = class(function(affineTransform)
...
polygon = class(function(polygon)
    function polygon.__init__(self, ...)
        local args = list {...}
        --[[ 
 ]]
...
animator = class(function(animator)
    function animator.__init__(self, ...)
        local args = list {...}
        --[[ 
...
imagetable = class(function(imagetable)
    function imagetable.__init__(self, ...)
        local args = list {...}
        --[[ 
...
sampleplayer = class(function(sampleplayer)
...
fileplayer = class(function(fileplayer)
    function fileplayer.__init__(self, ...)
        local args = list {...}
        --[[ 
...
frameTimer = class(function(frameTimer)
